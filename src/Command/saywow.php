    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        try {
            ...
            if($input->getArgument('nom_job_composite')=="0") {
                ...
                $historique->setPath('/var/log/saywow_succes' . $input->getArgument('nom_job_composite') . date("y-m-d-G-i-s") .'--'.$input->getArgument('dernier_Sous_Job'). '.log');
        ...
        return($input->getArgument('dernier_Sous_Job').'-----------------------------------------------');
    }
}
